...
const Footer = () => {
  return (
    <div className='xs:h-screen 2xl:h-fit bg-black py-8 md:py-0 px-8 md:px-16 font-abc border-t-[1px] border-gray-500'>
      ...
      <div className='flex md:flex-row max-w-7xl  flex-col  items-center gap-4 md:justify-between border-t-[0.5px] border-gray-300 py-8'>
