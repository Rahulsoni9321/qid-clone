    ...
    <>
      ...
      <MaxWidthWrapper>
        ...
        <div className="flex justify-between px-10 gap-8">
          <div className="font-abc font-bold text-6xl text-gray-200">Two Base elements of Identity ecosystem</div>
          <div className="flex justify-end gap-12 10/12 ">

          <BasicCard label={cardcontent[0].label} number={cardcontent[0].number} description={cardcontent[0].description} classname='rounded-[28px] flex flex-col gap-5 p-4 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] py-6 -mt-16 h-fit w-2/5 border-[1px] border-[#3a4239] bg-[#121e13]'></BasicCard>
          <BasicCard label={cardcontent[1].label} number={cardcontent[1].number} description={cardcontent[1].description}  classname='rounded-[28px] flex flex-col gap-6 p-4 pb-7 -mt-8 h-fit w-2/5 border-[1px] border-[#3a4239] bg-[#1a1407]/60  '></BasicCard>
          </div>
        </div>
      </MaxWidthWrapper>
